# UKB_socialrelationshipsatisfaction
...
friendship = fread("~/UKB_v2/Plink_files/UKB_friendshipbolt.txt")
family = fread("~/UKB_v2/Plink_files/UKB_familybolt.txt")

setnames(friendship, 1, "snpid")
setnames(friendship, 2, "chr")
setnames(friendship, 3, "bpos")
setnames(friendship, 5, "a1")
setnames(friendship, 6, "a2")
setnames(friendship, 7, "freq")
setnames(friendship, 12, "pval")
friendship$z = friendship$BETA/friendship$SE
friendship$n = "150000"
head(friendship)

friendshipmtag = friendship[,c("snpid", "chr", "bpos", "a1", "a2", "freq", "z","pval", "n")]

write.table(friendshipmtag, file = "/mnt/b2/home4/arc/vw260/UKB_v1/Plink_files/mtag/mtag/friendshipmtag.txt",
            row.names =F, col.names = T, quote = F)


python ~/UKB_v1/Plink_files/mtag/mtag/mtag.py --sumstats ~/UKB_v1/Plink_files/mtag/mtag/friendshipmtag.txt,~/UKB_v1/Plink_files/mtag/mtag/familymtag.txt --out ~/UKB_v1/Plink_files/mtag/mtag/friendshipfamilyboltmtag --n_min 0.0 --stream_stdout &

    
setnames(family, 1, "snpid")
setnames(family, 2, "chr")
setnames(family, 3, "bpos")
setnames(family, 5, "a1")
setnames(family, 6, "a2")
setnames(family, 7, "freq")
setnames(family, 12, "pval")
family$z = family$BETA/family$SE
family$n = "150000"

familymtag = family[,c("snpid", "chr", "bpos", "a1", "a2", "freq", "z", "pval", "n")]

write.table(familymtag, file = "/mnt/b2/home4/arc/vw260/UKB_v1/Plink_files/mtag/mtag/familymtag.txt",
            row.names =F, col.names = T, quote = F)
